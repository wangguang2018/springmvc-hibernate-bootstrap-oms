    ...
    var exports = {
        ...
        init: function(options) {
            ...
            $(".btn-search").on("click", function() {
                ...
                var createTimeStart =  Date.parse(new Date($("#gtCreateTime").val()));
                var createTimeEnd =  Date.parse(new Date($("#ltCreateTime").val()));
                if(createTimeStart>createTimeEnd){
                    Dialog.warning("结束日期必须在开始日期之后");
                    return;
                }
                ...
                var startDateStart =  Date.parse(new Date($("#gtStartDate").val()));
                var startDateEnd =  Date.parse(new Date($("#ltStartDate").val()));
