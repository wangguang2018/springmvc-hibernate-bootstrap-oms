                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/machine/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_mark" placeholder="机器编号" class="form-control search-cell">
                                    <input type="text" name="search_LIKE_sn" placeholder="机器设备号" class="form-control search-cell">
                                    <input type="text" name="search_LIKE_clientIp" placeholder="设备ip" class="form-control search-cell">
                                    ...
                                    <select class="form-control search-cell" name="search_EQ_fixStatus">
                                        <option value="">请选择是否维护</option>
                                        <option value="0">正常</option>
                                        <option value="1">系统设为维护</option>
                                        <option value="2">人工设置维护</option>
                                    </select>
                                    <select class="form-control search-cell" name="search_EQ_machineType">
...
<script src="${ctx}/static/js/machine/list.js"></script>
<script src="${ctx}/static/js/machine/machineParam.js"></script>
<script src="${ctx}/static/js/machine/modal.js"></script>
