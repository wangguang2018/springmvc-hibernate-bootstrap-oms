...
<c:set var="mainTitle" value="兑换大娃娃列表" />
<c:set var="subTitle" value="兑换大娃娃列表" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/product/exchangeBigDoll/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_name" placeholder="兑换大娃娃名称" class="form-control">
...
<script src="${ctx}/static/js/product/exchangeBigDoll/list.js"></script>
