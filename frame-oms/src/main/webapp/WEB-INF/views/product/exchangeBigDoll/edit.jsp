...
<head>
    <c:import url="/WEB-INF/layouts/header.jsp">
        <c:param name="question" value="兑换大娃娃管理"/>
    </c:import>
...
<c:set var="mainTitle" value="兑换大娃娃管理"/>
<c:set var="subTitle" value="编辑兑换大娃娃"/>
                            ...
                            <form id="form-edit" role="form" method="POST" class="form-horizontal"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label required">需要多少小娃娃才能兑换:</label>
                                            <div class="col-md-8">
                                                <input type="number" name="exchangeRate" id="exchangeRate" placeholder="请输入可兑换小娃娃数"
                                                       class="form-control" value="${product.exchangeRate}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" max="999999" min="0" name="stock" id="stock" placeholder="请输入商品库存"
                                                       class="form-control" value="${product.stock}">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label required">娃娃图片:</label>
...
<script src="${ctx}/static/js/product/exchangeBigDoll/edit.js"></script>
<script>
</script>
