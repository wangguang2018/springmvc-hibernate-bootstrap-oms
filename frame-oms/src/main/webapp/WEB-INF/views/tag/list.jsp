...
<head>
    <c:import url="/WEB-INF/layouts/header.jsp">
        <c:param name="question" value="标签管理"/>
    </c:import>
    <link href="${ctx}/static/libs/select2/css/select2.css" rel="stylesheet" type="text/css"/>
</head>

<c:set var="mainTitle" value="标签列表"/>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/tag/list">
                                <c:if test="${!isAgent}">
...
<script src="${ctx}/static/js/tag/list.js"></script>
