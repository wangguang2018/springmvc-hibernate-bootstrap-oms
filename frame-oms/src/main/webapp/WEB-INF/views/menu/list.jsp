...
<head>
    <c:import url="/WEB-INF/layouts/header.jsp">
        <c:param name="title" value="菜单管理 - 娃娃机" />
    </c:import>
</head>
                            ...
                            <form id="pagination-form" class="" method="POST" action="${ctx}/menus">
                                ...
                                <div class="action-group">
                                    ...
                                    <c:if test="${not empty pid}">
                                        <a href="${ctx}/menus" class="btn btn-default pull-right btn-back btn-default">返回</a>
                                    </c:if>
                                    <div class="btn-group">
                                        ...
                                        <ul role="menu" class="dropdown-menu animated swing">
                                            <shiro:hasPermission name="menu:update">
                                            <li><a href="javascript:void(0);" class="btn-edit-action" style="padding: 3px 20px;clear: both;">编辑</a>
                                            </li>
                                                </shiro:hasPermission>
