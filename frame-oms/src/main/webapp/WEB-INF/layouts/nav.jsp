    ...
    <nav role="navigation" class="navbar topnavbar">
        ...
        <div class="nav-wrapper">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="${ctx}/logout" question="Lock screen">
            ...
            <ul class="nav">
                ...
                <c:forEach items="${menus}" var="menu" varStatus="status">
                    <li class="${menu.id eq activeRootMenuId ? 'active' : ''}">
                        <a href="#parent_menu_${status.index}" question="Forms" data-toggle="collapse">
                            ...
                            <c:forEach items="${childMenus}" var="childMenu">
                                <c:if test="${childMenu.parentMenu.id eq menu.id}">
                                    <li class="${childMenu.id eq activeMenuId ? 'active' : ''}">
                                        <a href="${ctx}/${childMenu.url}?menu_id=${menu.id}&child_menu_id=${childMenu.id}"
                                           question="${childMenu.name}">
                    ...
                    <ul class="nav">
                        ...
                        <li>
                            ...
                            <a href="#" class="media-box p mt0">
                              <span class="pull-right">
                                ...
                                <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${ctx}/static/img/user/05.jpg" alt="Image"
                            ...
                            <a href="#" class="media-box p mt0">
                              <span class="pull-right">
                                ...
                                <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${ctx}/static/img/user/06.jpg" alt="Image"
                                      class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                                <span class="media-box-body">
                            ...
                            <a href="#" class="media-box p mt0">
                              <span class="pull-right">
                                ...
                                <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${ctx}/static/img/user/07.jpg" alt="Image"
                                      class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                                <span class="media-box-body">
                            ...
                            <a href="#" class="media-box p mt0">
                              <span class="pull-right">
                                ...
                                <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${ctx}/static/img/user/08.jpg" alt="Image"
                                      class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                                <span class="media-box-body">
                        ...
                        <li>
                            ...
                            <a href="#" class="media-box p mt0">
                              <span class="pull-right">
                                ...
                                <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${ctx}/static/img/user/09.jpg" alt="Image"
                                      class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                                <span class="media-box-body">
                            ...
                            <a href="#" class="media-box p mt0">
                              <span class="pull-right">
                                ...
                                <span class="pull-left">
                                 <!-- Contact avatar-->
                                 <img src="${ctx}/static/img/user/10.jpg" alt="Image"
                                      class="media-box-object img-circle thumb48">
                              </span>
                                <!-- Contact info-->
                                <span class="media-box-body">
                        ...
                        <li>
                            <div class="p-lg text-center">
                                ...
                                <a href="#" question="See more contacts" class="btn btn-purple btn-sm">
