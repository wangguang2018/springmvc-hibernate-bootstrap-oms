...
public class Servlets {
     ...
     */
    public static Map<String, Object> getParametersStartingWith(Map<String, Object> requestParams, String prefix) {
        Validate.notNull(requestParams, "Request must not be null");
